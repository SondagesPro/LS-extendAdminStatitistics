...
class statisticsHelper {
    ...
    */
     ...
     */
    protected $aLectraQuestionType=array(
        "F",
        "A",
        "B",
        "C",
    ...
    */
    ...
    public function generate_html_chartjs_statistics($surveyid, $allfields, $q2show='all', $usegraph=0, $outputType='pdf', $pdfOutput='I',$sLanguageCode=null, $browse = true)
    {
        ...
        */
        ...
        /**
         * Lectra statitistics : for base : get the default, else get the new function
         */
        if (isset($summary) && $summary)
        {
            ...
            foreach ($runthrough as $rt)
            {
                ...
                if($outputType=="html" && in_array($outputs['qtype'],$this->aLectraQuestionType))
                {
                    ...
                    {
                        //$sOutputHTML .= $outputs['statisticsoutput'];
                        $sOutputHTML.=$statisticsLectraHelper->getHtmlStatistics($outputs['parentqid'], $question[$outputs['parentqid']],$outputs['alist']);
